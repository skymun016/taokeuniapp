	...
	<view v-if="is_login==1">
		<view class="tui-mybg-box">
			<view class="tui-header-center">
				...
				<view class="tui-info">
					...
					<view class="tui-explain">{{detail.UsersRoles.title}}</view>
				</view>
			</view>
		</view>
		<view class="tui-content-box">
			<view class="tui-box tui-tool-box">
				<tui-list-view>
					<tui-list-cell @tap="navigateTo('/pagesA/my/admin/order')" :arrow="true">
						<view class="tui-item-box">
							<tui-icon name="clock-fill" :size="24" color="#5677fc"></tui-icon>
							<view class="tui-list-cell_name">订单管理</view>
						</view>
					</tui-list-cell>
					<!-- #ifdef MP-WEIXIN -->
					...
					<!-- #endif -->
					<tui-list-cell @tap="navigateTo('/pages/login/logout?ptype=admin')" :arrow="true">
						<view class="tui-item-box">
							<tui-icon name="setup" :size="24" color="#5677fc"></tui-icon>
...
<script>
	export default {
		...
		onShow() {
			let _this = this;
			_this.$request.get('admin.detail', {
					...
					uni.showModal({
						...
						success: function(res) {
							if (res.cancel) { //点击取消,默认隐藏弹框
								...
								uni.reLaunch({
									url: "/pages/login/userlogin?ptype=admin",
								})
							}
						}
					});
