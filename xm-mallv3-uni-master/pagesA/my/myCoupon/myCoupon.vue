<template>
	<view class="container">
		<tui-tabs :top="0" :tabs="tabs" :currentTab="currentTab" selectedColor="#E41F19" sliderBgColor="#E41F19" @change="change"
		...
		<view class="tui-coupon-list" :class="{'tui-mtop':scrollTop>=0}">
			<view class="tui-coupon-item tui-top20" v-for="(item,index) in couponList" :key="index">
				...
				<image  v-if="currentTab==0" src="/static/images/mall/coupon/img_couponcentre_received_3x.png" class="tui-coupon-sign"></image>
