<template>
	<view class="container">
		<form v-if="is_submitaudit!=1" @submit="bindSave">
			<view class="tui-form">
				<diyfields :ptype="ptype" update="1" gourl="/pagesA/my/admintuanzhang/index" gotype="navigateTo"  @complete="result"></diyfields>
			</view>
		</form>
