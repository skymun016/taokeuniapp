<template>
	<view class="container">
		<tui-tabs :top="0" :tabs="tabs" isFixed :currentTab="currentTab" selectedColor="#E41F19" sliderBgColor="#E41F19" @change="change" itemWidth="25%"></tui-tabs>
...
export default {
	...
	methods: {
		...
		detail() {
			...
			this.tui.href(`/pagesA/my/myGroup/myGroupDetail?status=${status}`);
		}
	},
	/**
	 * 页面相关事件处理函数--监听用户下拉动作
