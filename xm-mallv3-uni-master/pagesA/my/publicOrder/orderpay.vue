	...
	<view class="container">
		...
		<view class="tui-tabbar tui-order-btn">
			<view v-if="orderDetail.orderInfo.payment_code=='wx_pay' && orderDetail.orderInfo.order_status_id==1">
				<tui-button type="danger" width="300rpx" height="60rpx" :size="26" shape="circle"
	...
	export default {
		...
		methods: {
			...
			toPayTap: function(total, orderid) {
				const redirectUrl = "/pagesA/my/publicOrder/orderpay?id=" + this.orderDetail.orderInfo.id;
