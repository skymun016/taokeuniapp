		...
		<view class="tui-mybg-box">
			<view class="tui-header-center">
				<view class="tui-info">
					...
					<view class="tui-explain">一级代理</view>
				</view>
			</view>
		</view>
		<view class="tui-content-box">
			...
			<view  v-if="module==version3" class="tui-box tui-order-box" style="margin-top: 20rpx;">
				<tui-list-cell :arrow="true" padding="0" unlined :lineLeft="false"
					@click="navigateTo('/pagesA/my/adminoperatingcity/order?ptype=2')">
				...
				<view class="tui-order-list">
					<view class="tui-order-item" @tap="navigateTo('/pagesA/my/adminoperatingcity/order?currentTab=2&ptype=2')">
						<view class="tui-icon-box">
							<tui-icon name="signin" :size="30" color="#666666"></tui-icon>
						</view>
						<view class="tui-order-text">待指派</view>
					</view>
					<view class="tui-order-item" @tap="navigateTo('/pagesA/my/adminoperatingcity/order?currentTab=3&ptype=2')">
						<view class="tui-icon-box">
							<tui-icon name="feedback" :size="30" color="#666666"></tui-icon>
						</view>
						<view class="tui-order-text">服务中</view>
					</view>
					<view class="tui-order-item" @tap="navigateTo('/pagesA/my/adminoperatingcity/order?currentTab=5&ptype=2')">
						<view class="tui-icon-box">
							<tui-icon name="square-fill" :size="30" color="#666666"></tui-icon>
						</view>
						<view class="tui-order-text">已完成</view>
					</view>
					<view class="tui-order-item" @tap="navigateTo('/pagesA/my/adminoperatingcity/order?currentTab=6&ptype=2')">
						<view class="tui-icon-box">
							<tui-icon name="clock" :size="30" color="#666666"></tui-icon>
						</view>
						<view class="tui-order-text">售后单</view>
					</view>
				</view>
			</view>
			<view  v-if="module==version2" class="tui-box tui-order-box" style="margin-top: 20rpx;">
				<tui-list-cell :arrow="true" padding="0" unlined :lineLeft="false"
					@click="navigateTo('/pagesA/my/adminoperatingcity/order?ptype=1')">
					<view class="tui-cell-header">
						<view class="tui-cell-title">订单管理</view>
						<view class="tui-cell-sub">全部订单</view>
					</view>
				...
				<view class="tui-order-list">
					<view class="tui-order-item" @tap="navigateTo('/pagesA/my/adminoperatingcity/order?currentTab=2&ptype=1')">
						<view class="tui-icon-box">
							<tui-icon name="signin" :size="30" color="#666666"></tui-icon>
						</view>
						<view class="tui-order-text">待发货</view>
					</view>
					<view class="tui-order-item" @tap="navigateTo('/pagesA/my/adminoperatingcity/order?currentTab=3&ptype=1')">
						<view class="tui-icon-box">
							<tui-icon name="feedback" :size="30" color="#666666"></tui-icon>
						</view>
						<view class="tui-order-text">已发货</view>
					</view>
					<view class="tui-order-item" @tap="navigateTo('/pagesA/my/adminoperatingcity/order?currentTab=5&ptype=1')">
						<view class="tui-icon-box">
							<tui-icon name="square-fill" :size="30" color="#666666"></tui-icon>
						</view>
						<view class="tui-order-text">已完成</view>
					</view>
					<view class="tui-order-item" @tap="navigateTo('/pagesA/my/adminoperatingcity/order?currentTab=6&ptype=1')">
						<view class="tui-icon-box">
							<tui-icon name="clock" :size="30" color="#666666"></tui-icon>
						</view>
						<view class="tui-order-text">售后单</view>
			...
			<view class="tui-box tui-tool-box">
				<tui-list-view>
					<tui-list-cell v-if="detail.is_submitaudit!=1" @tap="navigateTo('/pagesA/my/withdraw/withdraw?mo=operatingcity')"
						:arrow="true">
					...
					<tui-list-cell @tap="navigateTo('/pagesA/my/withdraw/withdrawlog?mo=operatingcity')" :arrow="true">
						<view class="tui-item-box">
					...
					<!-- #endif -->
					<tui-list-cell @tap="navigateTo('/pagesA/my/adminoperatingcity/update')" :arrow="true">
						<view class="tui-item-box">
							<tui-icon name="setup" :size="24" color="#5677fc"></tui-icon>
							<view class="tui-list-cell_name">修改资料</view>
						</view>
					</tui-list-cell>
					<tui-list-cell  @tap="navigateTo('/pages/login/logout?ptype=operatingcity')" :arrow="true">
						<view class="tui-item-box">
							<tui-icon name="setup" :size="24" color="#5677fc"></tui-icon>
...
<script>
	export default {
		...
		onShow() {
			let _this = this;
			_this.$request.get('adminoperatingcity.detail', {
						...
						uni.showModal({
							...
							success: function(res) {
								if (res.cancel) { //点击取消,默认隐藏弹框
									...
									uni.reLaunch({
										url: "/pages/login/userlogin?ptype=operatingcity",
									})
								}
							}
						});
