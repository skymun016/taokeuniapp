<template>
	<view>
		<view></view>
		<tui-loading v-if="loadding" text="海报生成中"></tui-loading>
		...
		<view class="tui-poster__box">
			...
			<tui-button v-if="buttonshow" class="tui-poster__button" type="danger" width="460rpx" height="80rpx"
				shape="circle" @click="savePic">保存图片
			</tui-button>
		</view>
	</view>
	...
	export default {
		...
		methods: {
			async createPoster() {
				...
				var posterdata = await _this.$request.get('agent.poster', {
