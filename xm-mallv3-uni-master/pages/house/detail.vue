	...
	<view class="container">
		...
		<view class="tui-banner-swiper">
			...
			<view class="tui-share-position" @tap="showSharePopup">
				<tui-tag type="translucent" shape="circleLeft" padding="12rpx 16rpx">
					<view class="tui-share-box">
						<tui-icon name="partake" color="#fff" :size="15"></tui-icon>
			...
			<view class="tui-product-title tui-border-radius">
				...
				<view class="tui-padding">
					<view class="tui-sale-info tui-size tui-gray">
						<view>
							<view class="tui-bigtxt"><text>{{goodsDetail.price}}万</text></view>
							<view>售价</view>
						</view>
						<view>
							<view class="tui-bigtxt"><text>{{goodsDetail.room}}室{{goodsDetail.hall}}厅</text></view>
							<view>房型</view>
						</view>
						<view>
							<view class="tui-bigtxt"><text>{{goodsDetail.floorspace}}平米</text></view>
							<view>建筑面积</view>
						</view>
					</view>
				</view>
		...
		<view class="tui-operation">
			...
			<view class="tui-col-7">
				<view class="tui-operation-right tui-right-flex tui-btnbox-4">
					<view class="tui-flex-1">
						<!-- #ifdef MP-WEIXIN -->
						<button v-if="configkefu.minionline==1 || configkefu.minionline==3" @click="toim"
							class="itemwhitebutton68"
							:style="'border: 1rpx solid '+pagestyleconfig.appstylecolor+';color:'+ pagestyleconfig.appstylecolor">在线问</button>
						<button v-else-if="configkefu.minionline==2" @click="toimwebview(configkefu.kefuurl)"
							class="itemwhitebutton68"
							:style="'border: 1rpx solid '+pagestyleconfig.appstylecolor+';color:'+ pagestyleconfig.appstylecolor">在线问</button>
						<button v-else open-type="contact" class="itemwhitebutton68"
							:style="'border: 1rpx solid '+pagestyleconfig.appstylecolor+';color:'+ pagestyleconfig.appstylecolor">在线问</button>
						<!-- #endif -->
						<!-- #ifndef MP-WEIXIN -->
						<button v-if="configkefu.minionline==1 || configkefu.minionline==2 || configkefu.minionline==3"
							@click="toim" class="itemwhitebutton68"
							:style="'border: 1rpx solid '+pagestyleconfig.appstylecolor+';color:'+ pagestyleconfig.appstylecolor">在线问</button>
						<button v-else @click="tokefuTel" class="itemwhitebutton68"
							:style="'border: 1rpx solid '+pagestyleconfig.appstylecolor+';color:'+ pagestyleconfig.appstylecolor">在线问</button>
						<!-- #endif -->
					</view>
					<view class="tui-flex-1">
						<button class="itembutton68" @click="phoneCall"
							:style="'border: 1rpx solid '+pagestyleconfig.appstylecolor+';background:'+ pagestyleconfig.appstylecolor">打电话</button>
					</view>
				</view>
			</view>
		</view>
	...
	export default {
		...
		methods: {
			...
			getGoodsDetailInfo: function(goodsId) {
				const _this = this;
				_this.$request.get('house.detail', {
					id: goodsId,
					samkey: (new Date()).valueOf(),
					showLoading: true
				}).then(res => {
