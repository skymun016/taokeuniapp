-- 迁移文件: 001_create_initial_tables.sql
-- 描述: 创建初始数据表
-- 版本: 1.0.0
-- 创建时间: 2025-01-16

-- 检查数据库是否存在，如果不存在则创建
CREATE DATABASE IF NOT EXISTS `jd_affiliate` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- 创建同步日志表
CREATE TABLE IF NOT EXISTS `jd_sync_logs` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- 创建联盟链接缓存表
CREATE TABLE IF NOT EXISTS `jd_affiliate_links` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- 创建API调用统计表
CREATE TABLE IF NOT EXISTS `jd_api_stats` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
...
-- 创建系统配置表
CREATE TABLE IF NOT EXISTS `jd_system_config` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键ID',
